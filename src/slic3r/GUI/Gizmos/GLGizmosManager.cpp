...
bool GLGizmosManager::init()
{
    ...
    m_gizmos.emplace_back(new GLGizmoHoles(m_parent, m_is_dark ? "toolbar_vertical_holes_dark.svg" : "toolbar_vertical_holes.svg", EType::Holes)); // [ORCAPORT:ME-1]
...
std::string get_name_from_gizmo_etype(GLGizmosManager::EType type)
{
    ...
    case GLGizmosManager::EType::Holes: // [ORCAPORT:RF-1]
