...
bool GLGizmoSupportZones::seed_support_defaults(ModelObject &mo)
{
    ...
    // the removed ColorStitch/Neoweave contact feature and is registered in no config class.
    // Storing an unknown key into the object config makes UndoRedo's cereal snapshot null-deref
