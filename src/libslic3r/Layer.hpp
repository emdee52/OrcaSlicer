...
public:
    ...
    // [ORCAPORT:SU-10] This support layer holds the interface contact (touches the object); its
    // speed/line width can be overridden by the contact-interface options.
