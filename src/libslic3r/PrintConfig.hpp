...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,                bridge_expansion_extra)) // [ORCAPORT:PQ-1]
    ...
    // [ORCAPORT:PF-9] interlocking perimeters (native re-implementation on the shell generator)
    ((ConfigOptionBool, interlock_perimeters_enabled))
    ((ConfigOptionInt, interlock_perimeter_count))
    ((ConfigOptionInt, interlock_regular_perimeters))
    ((ConfigOptionInt, interlock_solid_layers_top))
    ((ConfigOptionInt, interlock_solid_layers_bottom))
